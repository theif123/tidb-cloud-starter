...
dotenv.config();
const { TIDB_USER = 'AFpd8DTgHBR37xk.root', TIDB_PASSWORD = 'MDFwWRqlg1GdEJYm', TIDB_HOST = 'gateway01.us-east-1.prod.aws.tidbcloud.com', TIDB_PORT = '4000', TIDB_DB_NAME = 'bookshop', DATABASE_URL } = process.env;
